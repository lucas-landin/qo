  ...
  return (
   <div className=' mb-40'>
    ...
    <div className=' flex gap-4 '>
       <a target='blanck' href='https://nextra.site/docs/docs-theme/start' className=' flex flex-col border border-slate-900/10 w-1/2'>
       ...
       <div className=' flex items-center  font-semibold border-t border-slate-900/10'>
        <p className=' py-4 px-2 flex items-center gap-2'>Documentation theme  
        <div >
        <Image 
        src={arrowText}
        width={13}
       ...
       <a target='blanck' href='https://nextra.site/docs/blog-theme/start' className=' flex flex-col border border-slate-900/10 w-1/2'>
       ...
       <div className=' flex items-center  font-semibold border-t border-slate-900/10'>
        <p className=' py-4 px-2 flex items-center gap-2'>Blog theme  
        <div >
        <Image 
        src={arrowText}
        width={13}
    ...
    <div className=' mt-10 font-semibold border-b border-slate-900/10'>
      <p className='mb-6 font-semibold text-4xl'>QOVES FAQ <span className=' text-hash text-4xl'>#</span></p>
    </div>
    <div className='my-6  '>
       <p className=' pb-2 text-primary '>The QOVES FAQ is a collection of useful questions and answers about the project. If you have a question that isn't answered here, please <a target='blanck' className=' text-blue-500 underline' href="https://github.com/shuding/nextra/discussions">open a discussion</a></p>
    </div>

    <div className='  flex flex-col  border border-slate-900/10 px-[8px] '>
      <a className='flex w-full items-center cursor-pointer py-1'onClick={toggleFaq} >
       <div className={` p-1 hover:bg-listf  ${rotateArrowFaq ? 'rotate-90' : ''}`} >
       <Image
       src={arrowRight}
       width={8}
       height={5}
      ...
      <div className={` overflow-hidden ${showFaq ? 'h-auto mt-2' : 'h-0'}`}>
        <p className='text-primary pl-1'>The answer is “yes” for most things. Since Nextra is just a Next.js plugin, almost all the things that can be done with React can be done with Nextra. Here are some examples and guides:</p>
        <ul className='flex flex-col gap-4 pl-6 my-6'>
          <li>
            <a href="https://nextra.site/docs/guide/advanced/tailwind-css" target='blanck' className=' text-blue-500 underline'>Use Tailwind CSS</a>
          </li>
          <li>
            <a href="https://nextra.site/docs/guide/custom-css" target='blanck' className=' text-blue-500 underline'>Use custom CSS and Sass</a>
          </li>
          <li>
            <a href="https://nextjs.org/docs/pages/building-your-application/optimizing/fonts" target='blanck' className=' text-blue-500 underline'>Use custom fonts</a>
          </li>
