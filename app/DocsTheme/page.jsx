...
function DocsTheme() {
    ...
    return ( 
     ...
     <div className=' mt-10 border-b border-slate-900/10'>
      <p className='mb-6 font-semibold text-4xl'>Quick Start from Template <span className=' text-hash text-4xl'>#</span></p>
    </div>

     <div className=" mt-6 mb-8">
      <p className=" text-2xl my-4 font-semibold">Deploy to Vercel</p>
      <p className=" text-primary ">Vercel will fork the <a target="blanck" className=" underline" href="https://nextra.site/docs/docs-theme">Nextra Docs template(opens in a new tab)</a> and deploy the site for you. Once done, every commit in the repository will be deployed automatically.</p>
     </div>

     <div>
     <p className=" text-2xl my-6 font-semibold">Fork Template</p>
     <p className=" text-primary">You can also manually fork the <a target="blanck" className=" underline" href="https://github.com/shuding/nextra-docs-template">template repository(opens in a new tab)</a></p>
     </div>
     
     <div className=' mt-10 border-b border-slate-900/10'>
      <p className='mb-6 font-semibold text-4xl'>Start as New Project <span className=' text-hash text-4xl'>#</span></p>
     </div>
     ...
     <div className=" border-l border-slate-900/10 mt-10">
         ...
         <p className=" text-primary">
          ...
          React, Nextra, and Nextra Docs Theme. In your project directory, run the following command 
          to install the dependencies: npm pnpm yarn bun</p>
         <div className=" border-b border-slate-900/10  mt-6">
           <div className=" flex gap-4 ">
            <a className=" border-b-[2px] border-blue-600 text-blue-600 cursor-pointer pb-1 px-2 ">npm</a>
         ...
         <div className=" mt-6 bg-listf w-full py-4 px-2 font-semibold ">
           <p className=" text-[#5ec897]"><span className=" text-violet-500">npm</span> i next react react-dom nextra nextra-theme-docs</p>
         </div>

         <div className=" py-2 px-2 my-6 bg-[#ffedd5] text-[#9a3412] font-semibold">
           <p>If you already have Next.js installed in your project, you only need to install nextra and nextra-theme-docs as the add-ons.</p>
         </div>
           ...
           <div className="font-semibold">
            <span className=" text-[#5ec897] ">"scripts":</span>{` {`} <br />
            <span className=" text-red-600 pl-3">"dev": </span> <span className="text-[#5ec897] ">"next",</span><br />
            <span className=" text-red-600 pl-3">"build": </span> <span className="text-[#5ec897] ">"next build",</span><br />
            <span className=" text-red-600 pl-3">"start": </span> <span className="text-[#5ec897] ">"next start"</span><br />
            {` },`}
           </div>
             </div>
         ...
         <div className=" flex w-full justify-around  pt-6 relative bottom-[-25px] ">
          ...
          <div className=' flex items-center  font-semibold border border-slate-900/10'>
            <p className=' py-4 px-4 uppercase flex items-center gap-2'>Page Structure  
          ...
          <div className=' flex items-center   font-semibold border border-slate-900/10'>
            <p className=' py-4 px-4 uppercase flex items-center gap-2'>Theme Configuration  
            <div className=" border-l border-slate-900/10 pl-2" >
            <Image 
            src={arrowText}
            width={13}
          ...
          <div className=' flex items-center   font-semibold border border-slate-900/10'>
            <p className=' py-4 px-4 uppercase flex items-center gap-2'>Built-in Components  
            <div className=" border-l border-slate-900/10 pl-2" >
            <Image 
            src={arrowText}
            width={13}
