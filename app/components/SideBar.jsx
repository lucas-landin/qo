    ...
    <div className="flex flex-col pt-6 text-primary ">
      <ul className=" list-none gap-1 flex flex-col">
        <li
          ...
          className={` p-[8px] ${
            activeLink === "Introduction" ? "activeLink" : ""
          }`}
        >
        ...
        <div
          className={`  border-l border-slate-900/10 pl-3 ml-2   overflow-hidden ${
            showGetStarted ? "h-auto" : "h-0"
          }`}
        >
          <ul className="flex flex-col gap-[10px]">
            <li
              ...
              className={` p-[8px] ${
                activeLink === "GetStarted" ? "activeLink" : ""
              }`}
            >
            ...
            <li className=" p-[8px]">Page Configuration</li>
            <li className=" p-[8px]">Theme Configuration</li>
            <li className=" p-[8px]">
              <a className="flex justify-between cursor-pointer">
                Built-ins
            ...
            <li className=" p-[8px]">
              <a className="flex justify-between cursor-pointer">
                API
                <div className="p-1 hover:bg-listf">
                  <Image src={arrowRight} width={8} height={5} alt="API" />
                </div>
              </a>
            </li>
          </ul>
